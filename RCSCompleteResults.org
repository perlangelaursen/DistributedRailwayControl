...
plot data u 1:2 w points title 'First model' linecolor rgb "black", \
     ...
     '+' u 1:(($1 <= 2) ? j($1) : 1/0) w l title sprintf("UMC fit: j(x) = %f * exp(%f * x)", i, j), \
     data u 1:($1 <= 4  ? $7 : 1/0) w p title 'UPPAALxUMC' linecolor rgb "black", \
     '+' u 1:(($1 <= 4) ? k($1) : 1/0) w l  title sprintf("UPPAALxUMC fit: k(x) = %f * exp(%f * x)", k, l)
#+end_src
...
plot data u 1:2 w points title 'First model' linecolor rgb "black", \
     ...
     '+' u 1:(($1 <= 4) ? k($1) : 1/0) w l  title sprintf("UPPAALxUMC fit: k(x) = %f * exp(%f * x)", i, j)
#+end_src
