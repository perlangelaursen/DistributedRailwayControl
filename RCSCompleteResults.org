...
|----------+-------------+-------------+------------+-------------+-----------|
|        1 | 0.011333333 | 0.013666667 |      0.017 | 0.026666667 | vmean([]) |
|        2 |       0.075 | 0.083666667 | 0.13566667 |       0.251 | vmean([]) |
|        4 |        1.72 |       1.415 |      2.482 |   5.5273333 | vmean([]) |
|        6 |       27.37 |      22.865 |  45.915667 |     108.261 | vmean([]) |
|        8 |   165.79533 |   134.60933 |  276.71933 |   630.82333 | vmean([]) |
|----------+-------------+-------------+------------+-------------+-----------|
...
| Stations | First model |  Restricted |      Global |      Cancel | UMC       |
|----------+-------------+-------------+-------------+-------------+-----------|
|        1 | 0.011666667 | 0.017333333 | 0.022666667 | 0.034666667 | vmean([]) |
|        2 | 0.073333333 |       0.074 |       0.141 |  0.27033333 | vmean([]) |
|        4 |   1.7076667 |       1.316 |        2.36 |       5.197 | vmean([]) |
|        6 |      29.484 |   22.226333 |   44.986333 |   108.01067 | vmean([]) |
|        8 |     165.246 |   135.38033 |   288.69767 |   634.25033 | vmean([]) |
|----------+-------------+-------------+-------------+-------------+-----------|
...
| Stations |  First model |  Restricted |      Global |      Cancel | UMC       |
|----------+--------------+-------------+-------------+-------------+-----------|
|        1 | 8.3333333e-3 | 0.014333333 | 0.021666667 | 0.031666667 | vmean([]) |
|        2 |  0.085333333 | 0.096666667 |  0.12733333 |  0.25333333 | vmean([]) |
|        4 |    1.7836667 |       1.289 |   2.6766667 |       5.281 | vmean([]) |
|        6 |    29.719667 |   23.231667 |   44.976333 |   107.55467 | vmean([]) |
|        8 |    165.38233 |   125.71833 |     286.938 |   637.43367 | vmean([]) |
|----------+--------------+-------------+-------------+-------------+-----------|
...
| Stations | First model |  Restricted |     Global |    Cancel | UMC       |
|----------+-------------+-------------+------------+-----------+-----------|
|        1 |        0.01 | 0.019333333 |      0.025 |     0.033 | vmean([]) |
|        2 | 0.076666667 | 0.072333333 | 0.13133333 |     0.229 | vmean([]) |
|        4 |   1.7113333 |   1.3063333 |       2.59 |     4.823 | vmean([]) |
|        6 |   27.375333 |      22.197 |  46.804333 |   106.595 | vmean([]) |
|        8 |   163.19167 |     134.605 |    285.323 | 654.14167 | vmean([]) |
|----------+-------------+-------------+------------+-----------+-----------|
...
| Stations | First model | Restricted |      Global |   Cancel | UMC       |
|----------+-------------+------------+-------------+----------+-----------|
|        1 |       0.016 |      0.015 | 0.035666667 |    0.035 | vmean([]) |
|        2 |  0.18566667 | 0.12533333 |  0.36466667 |     0.87 | vmean([]) |
|        4 |        8.13 |      2.373 |   11.708333 |   34.119 | vmean([]) |
|        6 |     176.259 |  47.547333 |   254.67733 |  895.692 | vmean([]) |
|        8 |   1127.1353 |  296.93933 |   1594.7723 | 6552.647 | vmean([]) |
|----------+-------------+------------+-------------+----------+-----------|
...
| Stations | First model |  Restricted |      Global |     Cancel | UMC       |
|----------+-------------+-------------+-------------+------------+-----------|
|        1 |       0.013 | 0.022666667 | 0.022333333 |      0.036 | vmean([]) |
|        2 |       0.198 |       0.133 |  0.36766667 | 0.87733333 | vmean([]) |
|        4 |   8.0706667 |       2.147 |      10.941 |  32.311333 | vmean([]) |
|        6 |     172.667 |      47.579 |     245.934 |    920.202 | vmean([]) |
|        8 |   1138.0233 |   292.37333 |    1694.755 |  6608.8023 | vmean([]) |
|----------+-------------+-------------+-------------+------------+-----------|
...
| Stations | First model |  Restricted |     Global |      Cancel | UMC       |
|----------+-------------+-------------+------------+-------------+-----------|
|        1 | 0.013333333 |       0.021 |      0.018 | 0.046333333 | vmean([]) |
|        2 | 0.085333333 | 0.096666667 | 0.12733333 |  0.25333333 | vmean([]) |
|        4 |   1.7836667 |       1.289 |  2.6766667 |       5.281 | vmean([]) |
|        6 |   29.719667 |   23.231667 |  44.976333 |   107.55467 | vmean([]) |
|        8 |   165.38233 |   125.71833 |    286.938 |   637.43367 | vmean([]) |
...
| Stations | First model | Restricted |    Global |    Cancel | UMC       |
|----------+-------------+------------+-----------+-----------+-----------|
|        1 |   6.5146667 |      8.508 |     8.412 | 8.7266667 | vmean([]) |
|        2 |       9.944 |  12.578667 |     14.96 | 16.641333 | vmean([]) |
|        4 |      41.508 |     39.384 | 58.201333 | 139.52667 | vmean([]) |
|        6 |   152.87467 |  122.78667 | 210.05733 | 680.33333 | vmean([]) |
|        8 |   422.32667 |    276.996 | 544.73333 | 2104.3453 | vmean([]) |
|----------+-------------+------------+-----------+-----------+-----------|
...
| Trains | First model | Restricted |    Global |    Cancel | UMC       |
|--------+-------------+------------+-----------+-----------+-----------|
|      2 |     122.196 |  113.55333 | 152.06533 | 238.94533 | vmean([]) |
|      3 |   1833.1293 |  313.88133 | 1303.3773 | 3638.7027 | vmean([]) |
|--------+-------------+------------+-----------+-----------+-----------|
...
| Stations | First model |  Restricted |      Global |      Cancel | UMC       |
|----------+-------------+-------------+-------------+-------------+-----------|
|        1 |       0.015 | 0.019333333 | 0.025666667 | 0.026666667 | vmean([]) |
|        2 |  0.19666667 |  0.11966667 |  0.33966667 |       0.815 | vmean([]) |
|        4 |   8.1093333 |       2.272 |       11.78 |   34.642333 | vmean([]) |
|        6 |     177.619 |   46.954333 |   260.88367 |   933.92167 | vmean([]) |
|        8 |   1133.7253 |     295.897 |   1657.4813 |   6625.0333 | vmean([]) |
|----------+-------------+-------------+-------------+-------------+-----------|
