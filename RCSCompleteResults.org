...
| Configuration   |    First |   Second |    Third | Average   |
|-----------------+----------+----------+----------+-----------|
| Station One     |    0.074 |    0.084 |    0.070 | vmean([]) |
| Station Two     |    2.505 |    2.606 |    2.612 | vmean([]) |
| Station Four    | 4164.950 | 4235.207 | 4300.883 | vmean([]) |
| Station Six     |          |          |          | vmean([]) |
| Station Eight   |          |          |          | vmean([]) |
| Nærumbanen (2T) |          |          |          | vmean([]) |
| Nærumbanen (3T) |          |          |          | vmean([]) |
...
| Configuration   |    First |   Second |    Third | Average   |
|-----------------+----------+----------+----------+-----------|
| Station One     |    8.584 |    8.604 |    8.632 | vmean([]) |
| Station Two     |   26.980 |   27.028 |   27.040 | vmean([]) |
| Station Four    | 4533.628 | 4533.628 | 4533.628 | vmean([]) |
| Station Six     |          |          |          | vmean([]) |
| Station Eight   |          |          |          | vmean([]) |
| Nærumbanen (2T) |          |          |          | vmean([]) |
| Nærumbanen (3T) |          |          |          | vmean([]) |
...
| Configuration   |    First |   Second |    Third | Average   |
|-----------------+----------+----------+----------+-----------|
| Station One     |    0.083 |    0.080 |    0.080 | vmean([]) |
| Station Two     |    2.657 |    2.624 |    2.599 | vmean([]) |
| Station Four    | 4107.677 | 4339.988 | 4246.319 | vmean([]) |
| Station Six     |          |          |          | vmean([]) |
| Station Eight   |          |          |          | vmean([]) |
| Nærumbanen (2T) |          |          |          | vmean([]) |
| Nærumbanen (3T) |          |          |          | vmean([]) |
...
| Configuration   |    First |   Second |    Third | Average   |
|-----------------+----------+----------+----------+-----------|
| Station One     |    8.528 |    8.544 |    8.548 | vmean([]) |
| Station Two     |   29.932 |   26.980 |   26.980 | vmean([]) |
| Station Four    | 4533.584 | 4533.576 | 4533.584 | vmean([]) |
| Station Six     |          |          |          | vmean([]) |
| Station Eight   |          |          |          | vmean([]) |
| Nærumbanen (2T) |          |          |          | vmean([]) |
| Nærumbanen (3T) |          |          |          | vmean([]) |
...
| Configuration   |    First |   Second |    Third | Average   |
|-----------------+----------+----------+----------+-----------|
| Station One     |    0.082 |    0.069 |    0.095 | vmean([]) |
| Station Two     |    2.607 |    2.726 |    2.557 | vmean([]) |
| Station Four    | 4102.210 | 4170.611 | 4313.341 | vmean([]) |
| Station Six     |          |          |          | vmean([]) |
| Station Eight   |          |          |          | vmean([]) |
| Nærumbanen (2T) |          |          |          | vmean([]) |
| Nærumbanen (3T) |          |          |          | vmean([]) |
...
| Configuration   |    First |   Second |    Third | Average   |
|-----------------+----------+----------+----------+-----------|
| Station One     |    8.536 |    8.560 |    8.588 | vmean([]) |
| Station Two     |   26.932 |   26.984 |   26.992 | vmean([]) |
| Station Four    | 4533.576 | 4533.580 | 4533.572 | vmean([]) |
| Station Six     |          |          |          | vmean([]) |
| Station Eight   |          |          |          | vmean([]) |
| Nærumbanen (2T) |          |          |          | vmean([]) |
| Nærumbanen (3T) |          |          |          | vmean([]) |
...
| Configuration   |    First |   Second |    Third | Average   |
|-----------------+----------+----------+----------+-----------|
| Station One     |    0.074 |    0.095 |    0.090 | vmean([]) |
| Station Two     |    2.696 |    2.539 |    2.519 | vmean([]) |
| Station Four    | 4103.429 | 4163.708 | 4172.222 | vmean([]) |
| Station Six     |          |          |          | vmean([]) |
| Station Eight   |          |          |          | vmean([]) |
| Nærumbanen (2T) |          |          |          | vmean([]) |
| Nærumbanen (3T) |          |          |          | vmean([]) |
...
| Configuration   |    First |   Second |    Third | Average   |
|-----------------+----------+----------+----------+-----------|
| Station One     |    8.472 |    8.472 |    8.472 | vmean([]) |
| Station Two     |   26.764 |   26.796 |   26.800 | vmean([]) |
| Station Four    | 4471.212 | 4471.196 | 4471.212 | vmean([]) |
| Station Six     |          |          |          | vmean([]) |
| Station Eight   |          |          |          | vmean([]) |
| Nærumbanen (2T) |          |          |          | vmean([]) |
| Nærumbanen (3T) |          |          |          | vmean([]) |
...
|----------+-------------+------------+---------+---------+-------+------------|
|        1 |       0.011 |      0.014 |   0.017 |   0.027 | 0.156 | vmean([])  |
|        2 |       0.075 |      0.084 |   0.136 |   0.251 |   8.6 | vmean([])  |
...
plot data u 1:2 w points title 'First model' linecolor rgb "black", \
     ...
     j(x) title sprintf("UMC fit: j(x) = %f * exp(%f * x), r = %8.4f", i, j, J_correlation)
#+end_src
