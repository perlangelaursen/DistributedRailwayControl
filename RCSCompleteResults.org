...
plot data u 1:2 w points title 'First model', \
     f(x) title 'First model fit', \
     data u 1:3 w points title 'Restricted', \
     g(x) title 'Restricted fit', \
     data u 1:4 w points title 'Global', \
     h(x) title 'Global fit', \
     data u 1:5 w points title 'Cancel', \
     i(x) title 'Cancel fit', \
     data u 1:6 w points title 'UMC', \
     j(x) title 'UMC fit'
#+end_src
