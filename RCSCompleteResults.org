...
| Configuration           |  First | Second |  Third | Average |
|-------------------------+--------+--------+--------+---------|
| Example with one train  |  0.074 |  0.072 |  0.072 |         |
| Example with two trains |  0.597 |  0.589 |  0.598 |         |
| Shared segment          |  0.278 |  0.278 |  0.279 |         |
| Large network           |        |        |        |         |
...
| Configuration           | First | Second | Third | Average |
|-------------------------+-------+--------+-------+---------|
| Example with one train  | 0.067 |  0.068 | 0.068 |         |
| Example with two trains | 0.409 |  0.408 | 0.412 |         |
| Shared segment          | 0.199 |  0.199 | 0.200 |         |
| Large network           |       |        |       |         |
...
| Configuration           |  First | Second |  Third | Average |
|-------------------------+--------+--------+--------+---------|
| Example with one train  |  0.063 |  0.063 |  0.064 |         |
| Example with two trains |  0.752 |  0.748 |  0.758 |         |
| Shared segment          |  0.342 |  0.341 |  0.341 |         |
| Large network           |        |        |        |         |
...
| Configuration           | First | Second | Third | Average |
|-------------------------+-------+--------+-------+---------|
| Example with one train  | 0.063 |  0.063 | 0.063 |         |
| Example with two trains | 0.282 |  0.282 | 0.281 |         |
| Shared segment          | 0.134 |  0.139 | 0.134 |         |
| Large network           |       |        |       |         |
...
| Configuration           |  First | Second |  Third | Average |
|-------------------------+--------+--------+--------+---------|
| Example with one train  |  0.079 |  0.081 |  0.079 |         |
| Example with two trains |  0.688 |  0.690 |  0.691 |         |
| Shared segment          |  0.335 |  0.334 |  0.350 |         |
| Large network           |        |        |        |         |
...
| Configuration           |  First | Second |  Third | Average |
|-------------------------+--------+--------+--------+---------|
| Example with one train  |  0.074 |  0.073 |  0.074 |         |
| Example with two trains |  0.460 |  0.459 |  0.458 |         |
| Shared segment          |  0.230 |  0.231 |  0.231 |         |
| Large network           |        |        |        |         |
...
| Configuration           |  First | Second |  Third | Average |
|-------------------------+--------+--------+--------+---------|
| Example with one train  |  0.066 |  0.066 |  0.066 |         |
| Example with two trains |  0.886 |  0.886 |  0.894 |         |
| Shared segment          |  0.417 |  0.415 |  0.416 |         |
| Large network           |        |        |        |         |
...
| Configuration           | First | Second | Third | Average |
|-------------------------+-------+--------+-------+---------|
| Example with one train  | 0.062 |  0.062 | 0.062 |         |
| Example with two trains | 0.275 |  0.264 | 0.262 |         |
| Shared segment          | 0.161 |  0.155 | 0.156 |         |
| Large network           |       |        |       |         |
