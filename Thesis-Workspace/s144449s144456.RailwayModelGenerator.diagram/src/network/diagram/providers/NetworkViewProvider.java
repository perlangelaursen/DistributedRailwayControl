 ...
 * @generated
 */
public class NetworkViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateDiagramViewOperation op) {
		return NetworkEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& NetworkVisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = NetworkVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = NetworkVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!NetworkElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType))) {
				...
				if (!NetworkEditPart.MODEL_ID.equals(NetworkVisualIDRegistry.getModelID(op.getContainerView()))) {
				...
				case TrainEditPart.VISUAL_ID:
					if (domainElement == null || visualID != NetworkVisualIDRegistry
		...
		return SwitchBoxEditPart.VISUAL_ID == visualID || RegularBoxEditPart.VISUAL_ID == visualID
				|| TrainEditPart.VISUAL_ID == visualID;
	}
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != NetworkVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = NetworkVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		} else {
			visualID = NetworkVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case SwitchBoxEditPart.VISUAL_ID:
			return createSwitchBox_2001(domainElement, containerView, index, persisted, preferencesHint);
		case RegularBoxEditPart.VISUAL_ID:
			return createRegularBox_2002(domainElement, containerView, index, persisted, preferencesHint);
		case TrainEditPart.VISUAL_ID:
			return createTrain_2004(domainElement, containerView, index, persisted, preferencesHint);
		}
	...
	* @generated
	*/
	public Node createSwitchBox_2001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setType(NetworkVisualIDRegistry.getType(SwitchBoxEditPart.VISUAL_ID));
		...
		Node label5001 = createLabel(node, NetworkVisualIDRegistry.getType(SwitchBoxIdEditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Node createRegularBox_2002(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(NetworkVisualIDRegistry.getType(RegularBoxEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5002 = createLabel(node, NetworkVisualIDRegistry.getType(RegularBoxIdEditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Node createTrain_2004(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(NetworkVisualIDRegistry.getType(TrainEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5004 = createLabel(node, NetworkVisualIDRegistry.getType(TrainIdEditPart.VISUAL_ID));
	...
	*/
	private void stampShortcut(View containerView, Node target) {
		if (!NetworkEditPart.MODEL_ID.equals(NetworkVisualIDRegistry.getModelID(containerView))) {
