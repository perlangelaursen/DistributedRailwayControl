...
import network.diagram.part.Messages;
...
public class NetworkNavigatorContentProvider implements ICommonContentProvider {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(topViews, NetworkEditPart.MODEL_ID), file, false));
	...
	*/
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case NetworkEditPart.VISUAL_ID: {
			...
			NetworkNavigatorGroup links = new NetworkNavigatorGroup(Messages.NavigatorGroupName_Network_1000_links,
					"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					NetworkVisualIDRegistry.getType(SwitchBoxEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					NetworkVisualIDRegistry.getType(RegularBoxEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					NetworkVisualIDRegistry.getType(TrainEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					NetworkVisualIDRegistry.getType(SegmentOneWayEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					NetworkVisualIDRegistry.getType(SegmentTwoWayEditPart.VISUAL_ID));
			links.addChildren(createNavigatorItems(connectedViews, links, false));
			if (!links.isEmpty()) {
				result.add(links);
			}
		...
		case SwitchBoxEditPart.VISUAL_ID: {
			...
			NetworkNavigatorGroup incominglinks = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_SwitchBox_2001_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			NetworkNavigatorGroup outgoinglinks = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_SwitchBox_2001_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case RegularBoxEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			NetworkNavigatorGroup incominglinks = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_RegularBox_2002_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			NetworkNavigatorGroup outgoinglinks = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_RegularBox_2002_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					NetworkVisualIDRegistry.getType(SegmentOneWayEditPart.VISUAL_ID));
		...
		case SegmentOneWayEditPart.VISUAL_ID: {
			...
			NetworkNavigatorGroup target = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_SegmentOneWay_4002_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			NetworkNavigatorGroup source = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_SegmentOneWay_4002_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case SegmentTwoWayEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			NetworkNavigatorGroup target = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_SegmentTwoWay_4003_target, "icons/linkTargetNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			NetworkNavigatorGroup source = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_SegmentTwoWay_4003_source, "icons/linkSourceNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					NetworkVisualIDRegistry.getType(SwitchBoxEditPart.VISUAL_ID));
	...
	*/
	 ...
	 * @generated
	 */
	private Collection<NetworkNavigatorItem> createNavigatorItems(Collection<View> views, Object parent,
			boolean isLeafs) {
		ArrayList<NetworkNavigatorItem> result = new ArrayList<NetworkNavigatorItem>(views.size());
		for (View nextView : views) {
