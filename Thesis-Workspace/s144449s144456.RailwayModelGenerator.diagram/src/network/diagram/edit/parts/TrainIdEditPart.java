...
import network.diagram.edit.policies.NetworkTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TrainIdEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(NetworkVisualIDRegistry.getType(network.diagram.edit.parts.TrainIdEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TrainIdEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new NetworkTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = NetworkParserProvider.getParser(NetworkElementTypes.Train_2004, getParserElement(),
					NetworkVisualIDRegistry.getType(network.diagram.edit.parts.TrainIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, NetworkEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
