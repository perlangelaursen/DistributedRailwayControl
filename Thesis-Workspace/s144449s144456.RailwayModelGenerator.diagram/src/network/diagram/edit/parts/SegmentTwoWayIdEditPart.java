 ...
 * @generated
 */
public class SegmentTwoWayIdEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				NetworkVisualIDRegistry.getType(network.diagram.edit.parts.SegmentTwoWayIdEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public SegmentTwoWayIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = NetworkParserProvider.getParser(NetworkElementTypes.SegmentTwoWay_4003, getParserElement(),
					NetworkVisualIDRegistry.getType(network.diagram.edit.parts.SegmentTwoWayIdEditPart.VISUAL_ID));
		}
		return parser;
	}
