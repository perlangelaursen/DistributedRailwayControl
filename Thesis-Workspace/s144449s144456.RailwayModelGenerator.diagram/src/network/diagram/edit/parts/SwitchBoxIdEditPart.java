 ...
 * @generated
 */
public class SwitchBoxIdEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				NetworkVisualIDRegistry.getType(network.diagram.edit.parts.SwitchBoxIdEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public SwitchBoxIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = NetworkParserProvider.getParser(NetworkElementTypes.SwitchBox_2001, getParserElement(),
					NetworkVisualIDRegistry.getType(network.diagram.edit.parts.SwitchBoxIdEditPart.VISUAL_ID));
		}
		return parser;
	}
