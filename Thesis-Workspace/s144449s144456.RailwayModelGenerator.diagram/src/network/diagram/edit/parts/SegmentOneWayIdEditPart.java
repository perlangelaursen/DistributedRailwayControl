 ...
 * @generated
 */
public class SegmentOneWayIdEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				NetworkVisualIDRegistry.getType(network.diagram.edit.parts.SegmentOneWayIdEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public SegmentOneWayIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = NetworkParserProvider.getParser(NetworkElementTypes.SegmentOneWay_4002, getParserElement(),
					NetworkVisualIDRegistry.getType(network.diagram.edit.parts.SegmentOneWayIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class SegmentId extends WrappingLabel {
