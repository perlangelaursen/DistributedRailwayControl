 ...
 * @generated
 */
public class SegmentOneWayReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public SegmentOneWayReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SegmentOneWay) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return NetworkBaseItemSemanticEditPolicy.getLinkConstraints().canExistSegmentOneWay_4002(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected SegmentOneWay getLink() {
		return (SegmentOneWay) getElementToEdit();
	}
