...
/**
 * This is the item provider adapter for a {@link network.Train} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TrainItemProvider extends ComponentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Train_route_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Train_route_feature", "_UI_Train_type"),
				 NetworkPackage.Literals.TRAIN__ROUTE,
				 true,
				 false,
				 true,
				 null,
