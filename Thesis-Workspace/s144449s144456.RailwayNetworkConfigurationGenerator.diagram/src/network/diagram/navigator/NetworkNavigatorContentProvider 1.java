	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case NetworkEditPart.VISUAL_ID: {
			...
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					NetworkVisualIDRegistry.getType(SegmentEditPart.VISUAL_ID));
		...
		case SwitchBoxEditPart.VISUAL_ID: {
			...
			NetworkNavigatorGroup incominglinks = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_SwitchBox_2005_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			NetworkNavigatorGroup outgoinglinks = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_SwitchBox_2005_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case RegularBoxEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			NetworkNavigatorGroup incominglinks = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_RegularBox_2006_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			NetworkNavigatorGroup outgoinglinks = new NetworkNavigatorGroup(
					Messages.NavigatorGroupName_RegularBox_2006_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					NetworkVisualIDRegistry.getType(SegmentEditPart.VISUAL_ID));
		...
		case SegmentEditPart.VISUAL_ID: {
			LinkedList<NetworkAbstractNavigatorItem> result = new LinkedList<NetworkAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			NetworkNavigatorGroup target = new NetworkNavigatorGroup(Messages.NavigatorGroupName_Segment_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			NetworkNavigatorGroup source = new NetworkNavigatorGroup(Messages.NavigatorGroupName_Segment_4004_source,
