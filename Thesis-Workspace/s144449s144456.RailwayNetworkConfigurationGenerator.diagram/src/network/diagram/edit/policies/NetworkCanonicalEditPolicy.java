...
import network.diagram.part.NetworkLinkDescriptor;
import network.diagram.part.NetworkNodeDescriptor;
...
public class NetworkCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(NetworkPackage.eINSTANCE.getNetwork_ControlBoxes());
			myFeaturesToSynchronize.add(NetworkPackage.eINSTANCE.getNetwork_Trains());
		}
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == SwitchBoxEditPart.VISUAL_ID || visualID == RegularBoxEditPart.VISUAL_ID
				|| visualID == TrainEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		for (Iterator<NetworkNodeDescriptor> descriptorsIterator = childDescriptors.iterator(); descriptorsIterator
				.hasNext();) {
	...
	* @generated
	*/
	private Collection<NetworkLinkDescriptor> collectAllLinks(View view, Domain2Notation domain2NotationMap) {
		...
		case SwitchBoxEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(NetworkDiagramUpdater.getSwitchBox_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case RegularBoxEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(NetworkDiagramUpdater.getRegularBox_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TrainEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(NetworkDiagramUpdater.getTrain_2004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
	...
	* @generated
	*/
	private Collection<IAdaptable> createConnections(Collection<NetworkLinkDescriptor> linkDescriptors,
		...
		for (NetworkLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					NetworkVisualIDRegistry.getType(nextLinkDescriptor.getVisualID()), ViewUtil.APPEND, false,
	...
	*/
	protected final EditPart getHintedEditPart(EObject domainModelElement, Domain2Notation domain2NotationMap,
		...
		View view = (View) domain2NotationMap.getHinted(domainModelElement,
				NetworkVisualIDRegistry.getType(hintVisualId));
		if (view != null) {
			return (EditPart) getHost().getViewer().getEditPartRegistry().get(view);
		}
		return null;
