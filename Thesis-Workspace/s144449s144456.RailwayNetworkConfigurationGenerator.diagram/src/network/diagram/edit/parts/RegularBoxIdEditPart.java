 ...
 * @generated
 */
public class RegularBoxIdEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				NetworkVisualIDRegistry.getType(network.diagram.edit.parts.RegularBoxIdEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public RegularBoxIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = NetworkParserProvider.getParser(NetworkElementTypes.RegularBox_2002, getParserElement(),
					NetworkVisualIDRegistry.getType(network.diagram.edit.parts.RegularBoxIdEditPart.VISUAL_ID));
		}
		return parser;
	}
