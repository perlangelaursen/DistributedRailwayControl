 ...
 * @generated
 */
public class SegmentIdEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				NetworkVisualIDRegistry.getType(network.diagram.edit.parts.SegmentIdEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public SegmentIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = NetworkParserProvider.getParser(NetworkElementTypes.Segment_4004, getParserElement(),
					NetworkVisualIDRegistry.getType(network.diagram.edit.parts.SegmentIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SegmentIdFigure();
	}

	/**
	 * @generated
	 */
	public class SegmentIdFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SegmentIdFigure() {
			this.setText("<...>");
		}
