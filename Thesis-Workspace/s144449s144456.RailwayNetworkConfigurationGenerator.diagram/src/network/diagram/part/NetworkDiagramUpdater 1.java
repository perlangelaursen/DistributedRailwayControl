...
public class NetworkDiagramUpdater {
	...
	*/
	public static List<NetworkLinkDescriptor> getContainedLinks(View view) {
		...
		case SwitchBoxEditPart.VISUAL_ID:
			return getSwitchBox_2005ContainedLinks(view);
		case RegularBoxEditPart.VISUAL_ID:
			return getRegularBox_2006ContainedLinks(view);
		case TrainEditPart.VISUAL_ID:
			return getTrain_2007ContainedLinks(view);
	...
	*/
	public static List<NetworkLinkDescriptor> getIncomingLinks(View view) {
		switch (NetworkVisualIDRegistry.getVisualID(view)) {
		case SwitchBoxEditPart.VISUAL_ID:
			return getSwitchBox_2005IncomingLinks(view);
		case RegularBoxEditPart.VISUAL_ID:
			return getRegularBox_2006IncomingLinks(view);
		case TrainEditPart.VISUAL_ID:
			return getTrain_2007IncomingLinks(view);
		case SegmentEditPart.VISUAL_ID:
	...
	*/
	public static List<NetworkLinkDescriptor> getOutgoingLinks(View view) {
		switch (NetworkVisualIDRegistry.getVisualID(view)) {
		case SwitchBoxEditPart.VISUAL_ID:
			return getSwitchBox_2005OutgoingLinks(view);
		case RegularBoxEditPart.VISUAL_ID:
			return getRegularBox_2006OutgoingLinks(view);
		case TrainEditPart.VISUAL_ID:
			return getTrain_2007OutgoingLinks(view);
		case SegmentEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public static List<NetworkLinkDescriptor> getSwitchBox_2005ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<NetworkLinkDescriptor> getRegularBox_2006ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<NetworkLinkDescriptor> getTrain_2007ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<NetworkLinkDescriptor> getSwitchBox_2005IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<NetworkLinkDescriptor> getRegularBox_2006IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<NetworkLinkDescriptor> getTrain_2007IncomingLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<NetworkLinkDescriptor> getSwitchBox_2005OutgoingLinks(View view) {
		SwitchBox modelElement = (SwitchBox) view.getElement();
		LinkedList<NetworkLinkDescriptor> result = new LinkedList<NetworkLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<NetworkLinkDescriptor> getRegularBox_2006OutgoingLinks(View view) {
		RegularBox modelElement = (RegularBox) view.getElement();
		LinkedList<NetworkLinkDescriptor> result = new LinkedList<NetworkLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Segment_4004(modelElement));
		return result;
	 ...
	 * @generated
	 */
	public static List<NetworkLinkDescriptor> getTrain_2007OutgoingLinks(View view) {
		return Collections.emptyList();
	}
